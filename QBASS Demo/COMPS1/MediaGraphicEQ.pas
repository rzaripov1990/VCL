...
type
  ...
  TEQChange = procedure(Sender: TObject; const ID: integer; const Position: Single; const SetPosition: boolean)
    of object;
  ...
  published
    ...
    property BandCount: TBandCount read fBandCount write SetBandCount default 10;

    property BorderType: TMediaEQBorder read fBorderType write SetBorderType default mebNone;
    property BorderColor: TColor read fBorderColor write SetborderColor default clGray;

    property CurveColor: TColor read fCurveClr write SetCurveClr default clWhite;
    property MiddleColor: TColor read fMiddle write SetMiddleLineColor default clYellow;
    property DrawPreAmp: boolean read fDrawPreAmp write SetDrawPreAmp default True;
...
// ******************************************************************************
procedure TZMSMediaGraphicEQ.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: integer);
var
  Off: integer;
begin
  inherited;
...
// ******************************************************************************
procedure TZMSMediaGraphicEQ.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: integer);
begin
  inherited;
...
begin
  ...
  begin
    ...
    for i := 0 to fBandCount - 1 do
      fBuffer.Canvas.LineTo(Trunc(CalcBandPosX(i)), Trunc(CalcBandPosY(fEQItems[i])));
  end;
