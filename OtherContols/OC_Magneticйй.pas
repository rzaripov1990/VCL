...
type
  ...
  private
    ...
    procedure zSubclass_Proc(lng_hWnd: HWND; uMsg, wParam, lParam: Integer;
      var lReturn: NativeInt; var bHandled: Boolean);
  public
...
var
  MagneticWnd: TMagnetic; // global var
...
procedure TMagnetic.zSubclass_Proc(lng_hWnd: HWND;
  uMsg, wParam, lParam: Integer; var lReturn: NativeInt; var bHandled: Boolean);
{
  Parameters:
