...
const
  ...
  { Profile names }
  MPP_PROFILE: array [0 .. 12] of string = ('Unknown', 'Thumb', 'Radio', 'Standard', 'Xtreme', 'Insane', 'BrainDead',
...
begin
  ...
  begin
    case (EncoderID mod 10) of
      0:
        Result := format('%u.%u Release', [EncoderID div 100, (EncoderID div 10) mod 10]);
      2, 4, 6, 8:
...
begin
  ...
  if FID3v2.LoadFromFile(FileName) = 0 then
