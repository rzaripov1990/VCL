...
type
  ...
  TacSLAlphaMode = (slamNone, slamNormalAlpha, slamMask, slamRed, slamGreen,
    slamBlue, slamRejection);
  ...
  TacSLPenStyle = (slpsContinuous, slpsDots, slpsLines, slpsDotsLines,
    slpsMicroLines);
  ...
  public
    ...
    property GradientMode: TacSLGradientMode read FGradientMode
      write FGradientMode;
  end;
  ...
  public
    ...
    property RGBAQuadroGradientLT: TacSLColor read FRGBAQuadroGradientLT
      write FRGBAQuadroGradientLT;
    property RGBAQuadroGradientRT: TacSLColor read FRGBAQuadroGradientRT
      write FRGBAQuadroGradientRT;
    property RGBAQuadroGradientLB: TacSLColor read FRGBAQuadroGradientLB
      write FRGBAQuadroGradientLB;
    property RGBAQuadroGradientRB: TacSLColor read FRGBAQuadroGradientRB
      write FRGBAQuadroGradientRB;
  end;
  ...
  private
    ...
    procedure GetGradientRGB(GMode: TacSLGradientMode;
      InputColor1, InputColor2: TacSLColor; Reverse: boolean;
      out R, G, B, a: Byte);
    ...
    procedure DrawHGradientLine(x1, x2, Y: Integer; Reverse: boolean;
      Ex: boolean);
    procedure DrawVGradientLine(y1, y2, X: Integer; Reverse: boolean;
      Ex: boolean);
  ...
  public
    ...
    constructor Create(PVideoData: Pointer;
      AWidth, AHeight, APitch: Integer); overload;
    ...
    procedure GradientLineToEx(X, Y: Integer; Reverse: boolean;
      VectorLen, VectorPos: Integer);
    ...
    procedure GradientFill(x1, y1, x2, y2: Integer; Reverse: boolean;
      Style: TacSLGradientStyle); overload;
    procedure GradientFill(Rect: TRect; Reverse: boolean;
      Style: TacSLGradientStyle); overload;
    procedure GradientFill(Point1, Point2: TPoint; Reverse: boolean;
      Style: TacSLGradientStyle); overload;
    ...
    // Захвачиваем память
    function AttachTo(PVideoData: Pointer; AWidth, AHeight, APitch: Integer)
      : boolean; overload;
    ...
    procedure Draw(X, Y: Integer; Bitmap: TBitmap;
      AlphaReverse: boolean); overload;
    procedure Draw(X, Y: Integer; SLCanvas32: TacSLCanvas32;
      AlphaReverse: boolean); overload;
    ...
    property PixelRGBA[X, Y: Integer]: PRGBQuad read GetPixelRGBA
      write SetPixelRGBA;
    property PixelColor[X, Y: Integer]: TColor read GetPixelColor
      write SetPixelColor;

    property PixelRValue[X, Y: Integer]: Byte read GetPixelRValue
      write SetPixelRValue;
    property PixelGValue[X, Y: Integer]: Byte read GetPixelGValue
      write SetPixelGValue;
    property PixelBValue[X, Y: Integer]: Byte read GetPixelBValue
      write SetPixelBValue;
    property PixelAValue[X, Y: Integer]: Byte read GetPixelAValue
      write SetPixelAValue;
...
const
  ...
  TVImageFilter: TacSLDigitalFilter = ((50, 50, 50), (50, 50, 50),
    (50, 50, 50));
...
begin
  ...
  Sum := DF[0, 0] + DF[1, 0] + DF[2, 0] + DF[0, 1] + DF[1, 1] + DF[2, 1] +
  ...
  begin
    ...
    begin
      ...
      for i := 0 to 2 do
        for j := 0 to 2 do
        begin
          Tmp := Dst.PixelRGBA[TrimInt(X + i - 1, 0, Dst.Width - 1),
            TrimInt(Y + j - 1, 0, Dst.Height - 1)];
...
begin
  ...
  begin
    ...
    begin
      ...
      pc.rgbBlue := (Buf[0].rgbBlue + Buf[1].rgbBlue + Buf[2].rgbBlue +
        Buf[3].rgbBlue) shr 2;
      pc.rgbGreen := (Buf[0].rgbGreen + Buf[1].rgbGreen + Buf[2].rgbGreen +
        Buf[3].rgbGreen) shr 2;
      pc.rgbRed := (Buf[0].rgbRed + Buf[1].rgbRed + Buf[2].rgbRed +
        Buf[3].rgbRed) shr 2;
      Inc(pc);
    end
  end
...
function TacSLCanvas32.AttachTo(PVideoData: Pointer;
  AWidth, AHeight, APitch: Integer): boolean;
var
  i: Integer;
begin
  DetachMemory;
  ...
  begin
    ...
    FDeltaAddress := Integer(Cardinal(PVideoData) + Cardinal(1 * FDelta * 4)) -
      FStartAddress;
  end
  else
  begin
    ...
    begin
      ...
      begin
        ...
        for i := 0 to FHeight - 1 do
          FScanLines[i] :=
            Pointer(Cardinal(FVideoData) + Cardinal(i * FDelta * 4));

        FStartAddress := Integer(FVideoData);
        FDeltaAddress := Integer(Cardinal(FVideoData) + Cardinal(1 * FDelta * 4)
          ) - FStartAddress;
      end
      else
      begin
...
begin
  ...
  begin
    ...
    begin
      ...
      GetGradientRGB(FBrush.FGradientMode, FBrush.FRGBAColor,
        FBrush.FRGBAGradient, Reverse, SpecialColorTemp.FRed,
        SpecialColorTemp.FGreen, SpecialColorTemp.FBlue,
        SpecialColorTemp.FAlphaBlend);
...
procedure TacSLCanvas32.Draw(X, Y: Integer; Bitmap: TBitmap;
...
procedure TacSLCanvas32.Draw(X, Y: Integer; SLCanvas32: TacSLCanvas32;
  AlphaReverse: boolean);
var
  x1, y1: Integer;
  x2, y2: Integer;
begin
  ...
  begin
    ...
    begin
      if (SLCanvas32.AttachedMemory) and (FVideoData <> SLCanvas32.ScanLine[0])
      then
      begin
        x2 := X;
        y2 := Y;
...
procedure TacSLCanvas32.DrawBrushHLine(x1, x2, Y: Integer;
  InPutRGBA: TacSLColor);
var
  t: Integer;
begin
  if (x1 > x2) then
...
procedure TacSLCanvas32.DrawBrushVLine(y1, y2, X: Integer;
  InPutRGBA: TacSLColor);
var
  t: Integer;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if p <> nil then
          begin
            SpecialColorTemp.Blue := (p^.rgbBlue - FPen.FRGBAColor.FBlue) *
              ci shr 8 + FPen.FRGBAColor.FBlue;
            SpecialColorTemp.Green := (p^.rgbGreen - FPen.FRGBAColor.FGreen) *
              ci shr 8 + FPen.FRGBAColor.FGreen;
            SpecialColorTemp.Red := (p^.rgbRed - FPen.FRGBAColor.FRed) *
              ci shr 8 + FPen.FRGBAColor.FRed;
          ...
          if p <> nil then
          begin
            SpecialColorTemp.Blue := (FPen.FRGBAColor.FBlue - p^.rgbBlue) *
              ci shr 8 + p^.rgbBlue;
            SpecialColorTemp.Green := (FPen.FRGBAColor.FGreen - p^.rgbGreen) *
              ci shr 8 + p^.rgbGreen;
            SpecialColorTemp.Red := (FPen.FRGBAColor.FRed - p^.rgbRed) *
              ci shr 8 + p^.rgbRed;
...
procedure TacSLCanvas32.DrawHGradientLine(x1, x2, Y: Integer; Reverse: boolean;
  Ex: boolean);
var
  t: Integer;
begin
  if (x1 > x2) then
  begin
    GetGradientRGB(FPen.FGradientMode, FPen.FRGBAColor, FPen.FRGBAGradient,
      Reverse, GradientColorTemp.FRed, GradientColorTemp.FGreen,
      GradientColorTemp.FBlue, GradientColorTemp.FAlphaBlend);
...
procedure TacSLCanvas32.DrawVGradientLine(y1, y2, X: Integer; Reverse: boolean;
  Ex: boolean);
var
  t: Integer;
begin
...
procedure TacSLCanvas32.GradientLineToEx(X, Y: Integer; Reverse: boolean;
  VectorLen, VectorPos: Integer);
var
  d, ax, ay, sx, sy, dx, dy: Integer;
  x1, y1, x2, y2: Integer;
...
procedure TacSLCanvas32.GradientFill(x1, y1, x2, y2: Integer; Reverse: boolean;
  Style: TacSLGradientStyle);
var
  i: Integer;
  X, Y: Integer;
  x3, y3: Integer;
...
procedure TacSLCanvas32.GradientFill(Rect: TRect; Reverse: boolean;
  Style: TacSLGradientStyle);
begin
...
begin
  ...
  begin
    ...
    if (FBrush.FGradientMode = slgmNormal) or
      (FBrush.FGradientMode = slgmOnlyColor) then
    begin
      xx := ((FBrush.FRGBAQuadroGradientLT.FRed * iz +
        FBrush.FRGBAQuadroGradientLB.FRed * z) shr 16);
      rp := xx shl 16;
      rp2 := (((FBrush.FRGBAQuadroGradientRT.FRed * iz +
        FBrush.FRGBAQuadroGradientRB.FRed * z) shr 16) - xx) * t;

      xx := ((FBrush.FRGBAQuadroGradientLT.FGreen * iz +
        FBrush.FRGBAQuadroGradientLB.FGreen * z) shr 16);
      gp := xx shl 16;
      gp2 := (((FBrush.FRGBAQuadroGradientRT.FGreen * iz +
        FBrush.FRGBAQuadroGradientRB.FGreen * z) shr 16) - xx) * t;

      xx := ((FBrush.FRGBAQuadroGradientLT.FBlue * iz +
        FBrush.FRGBAQuadroGradientLB.FBlue * z) shr 16);
      bp := xx shl 16;
      bp2 := (((FBrush.FRGBAQuadroGradientRT.FBlue * iz +
        FBrush.FRGBAQuadroGradientRB.FBlue * z) shr 16) - xx) * t;
    end;

    // Если нужно прощитывать альфу, то вперёд!
    if (FBrush.FGradientMode = slgmNormal) or
      (FBrush.FGradientMode = slgmOnlyAlpha) then
    begin
      xx := ((FBrush.FRGBAQuadroGradientLT.FAlphaBlend * iz +
        FBrush.FRGBAQuadroGradientLB.FAlphaBlend * z) shr 16);
      ap := xx shl 16;
      ap2 := (((FBrush.FRGBAQuadroGradientRT.FAlphaBlend * iz +
        FBrush.FRGBAQuadroGradientRB.FAlphaBlend * z) shr 16) - xx) * t;
    end;
...
constructor TacSLCanvas32.Create(PVideoData: Pointer;
...
procedure TacSLCanvas32.GetGradientRGB(GMode: TacSLGradientMode;
  InputColor1, InputColor2: TacSLColor; Reverse: boolean; out R, G, B, a: Byte);
var
  h, i: Integer;
...
begin
  ...
  begin
    ...
    begin
      if FPen.PenMode = slpmNormal then
      begin
        Inc(Pixel^.rgbRed, (FPen.RGBAColor.AlphaBlend * (FPen.RGBAColor.Red -
          Pixel^.rgbRed)) shr 8);
        Inc(Pixel^.rgbGreen,
          (FPen.RGBAColor.AlphaBlend * (FPen.RGBAColor.Green -
          Pixel^.rgbGreen)) shr 8);
        Inc(Pixel^.rgbBlue, (FPen.RGBAColor.AlphaBlend * (FPen.RGBAColor.Blue -
          Pixel^.rgbBlue)) shr 8);
      end
      else
      begin
        Pixel^.rgbRed := Pixel^.rgbRed +
          (FPen.RGBAColor.AlphaBlend * ((Pixel^.rgbRed xor FPen.RGBAColor.Red) -
          Pixel^.rgbRed)) shr 8;
        Pixel^.rgbGreen := Pixel^.rgbGreen +
          (FPen.RGBAColor.AlphaBlend *
          ((Pixel^.rgbGreen xor FPen.RGBAColor.Green) - Pixel^.rgbGreen)) shr 8;
        Pixel^.rgbBlue := Pixel^.rgbBlue +
          (FPen.RGBAColor.AlphaBlend * ((Pixel^.rgbBlue xor FPen.RGBAColor.Blue)
          - Pixel^.rgbBlue)) shr 8;
      end
    end
  end
...
begin
  ...
  begin
    ...
    begin
      if FPen.PenMode = slpmNormal then
      begin
        Inc(Pixel^.rgbRed, (FPen.FRGBAColor.AlphaBlend * (SpecialColorTemp.FRed
          - Pixel^.rgbRed)) shr 8);
        Inc(Pixel^.rgbGreen,
          (FPen.FRGBAColor.AlphaBlend * (SpecialColorTemp.FGreen -
          Pixel^.rgbGreen)) shr 8);
        Inc(Pixel^.rgbBlue,
          (FPen.FRGBAColor.AlphaBlend * (SpecialColorTemp.FBlue -
          Pixel^.rgbBlue)) shr 8);
      end
      else
      begin
        Pixel^.rgbRed := Pixel^.rgbRed +
          (FPen.RGBAColor.AlphaBlend *
          ((Pixel^.rgbRed xor SpecialColorTemp.FRed) - Pixel^.rgbRed)) shr 8;
        Pixel^.rgbGreen := Pixel^.rgbGreen +
          (FPen.RGBAColor.AlphaBlend *
          ((Pixel^.rgbGreen xor SpecialColorTemp.FGreen) -
          Pixel^.rgbGreen)) shr 8;
        Pixel^.rgbBlue := Pixel^.rgbBlue +
          (FPen.RGBAColor.AlphaBlend *
          ((Pixel^.rgbBlue xor SpecialColorTemp.FBlue) - Pixel^.rgbBlue)) shr 8;
      end
    end
  end
end;
...
procedure TacSLCanvas32.RendererPixel(X, Y: Integer; Source: PRGBQuad;
  Reverse: boolean);
var
  Pixel: PRGBQuad;
  AlphaBuffer: Byte;
begin
  ...
  begin
    Inc(Pixel^.rgbRed, (FBrush.FRGBAColor.FAlphaBlend * (Source^.rgbRed -
      Pixel^.rgbRed)) shr 8);
    Inc(Pixel^.rgbGreen, (FBrush.FRGBAColor.FAlphaBlend * (Source^.rgbGreen -
      Pixel^.rgbGreen)) shr 8);
    Inc(Pixel^.rgbBlue, (FBrush.FRGBAColor.FAlphaBlend * (Source^.rgbBlue -
      Pixel^.rgbBlue)) shr 8);
  end
  else if FBrush.FAlphaMode = slamMask then // Рисуем по маске
  begin
    Inc(Pixel^.rgbRed, (Source^.rgbReserved * (Source^.rgbRed -
      Pixel^.rgbRed)) shr 8);
    Inc(Pixel^.rgbGreen,
      (Source^.rgbReserved * (Source^.rgbGreen - Pixel^.rgbGreen)) shr 8);
    Inc(Pixel^.rgbBlue,
      (Source^.rgbReserved * (Source^.rgbBlue - Pixel^.rgbBlue)) shr 8);
  end
  else if (FBrush.FAlphaMode = slamRed) or (FBrush.FAlphaMode = slamGreen) or
    (FBrush.FAlphaMode = slamBlue) or (FBrush.FAlphaMode = slamRejection) then
  // Делаем прозрачным указанный цвет
  begin
    if FBrush.FAlphaMode = slamRed then
      AlphaBuffer := ExtractNotRed(Source^.rgbRed, Source^.rgbGreen,
        Source^.rgbBlue)
    else if FBrush.FAlphaMode = slamGreen then
      AlphaBuffer := ExtractNotGreen(Source^.rgbRed, Source^.rgbGreen,
        Source^.rgbBlue)
    else if FBrush.FAlphaMode = slamBlue then
      AlphaBuffer := ExtractNotBlue(Source^.rgbRed, Source^.rgbGreen,
        Source^.rgbBlue)
    else if FBrush.FAlphaMode = slamRejection then
      AlphaBuffer := ExtractRejection(Source^.rgbRed, Source^.rgbGreen,
        Source^.rgbBlue);

    Inc(Pixel^.rgbRed, (AlphaBuffer * (Source^.rgbRed - Pixel^.rgbRed)) shr 8);
    Inc(Pixel^.rgbGreen,
      (AlphaBuffer * (Source^.rgbGreen - Pixel^.rgbGreen)) shr 8);
    Inc(Pixel^.rgbBlue,
      (AlphaBuffer * (Source^.rgbBlue - Pixel^.rgbBlue)) shr 8);
  end
  else if FBrush.FAlphaMode = slamRejection then
  begin
    Inc(Pixel^.rgbRed, (Source^.rgbReserved * (Source^.rgbRed -
...
begin
  ...
  begin
    ...
    begin
      if FPen.PenMode = slpmNormal then
      begin
        Inc(Pixel^.rgbRed, (GradientColorTemp.AlphaBlend *
          (GradientColorTemp.Red - Pixel^.rgbRed)) shr 8);
        Inc(Pixel^.rgbGreen,
          (GradientColorTemp.AlphaBlend * (GradientColorTemp.Green -
          Pixel^.rgbGreen)) shr 8);
        Inc(Pixel^.rgbBlue, (GradientColorTemp.AlphaBlend *
          (GradientColorTemp.Blue - Pixel^.rgbBlue)) shr 8);
      end
      else
      begin
        Pixel^.rgbRed := Pixel^.rgbRed +
          (GradientColorTemp.FAlphaBlend *
          ((Pixel^.rgbRed xor GradientColorTemp.FRed) - Pixel^.rgbRed)) shr 8;
        Pixel^.rgbGreen := Pixel^.rgbGreen +
          (GradientColorTemp.FAlphaBlend *
          ((Pixel^.rgbGreen xor GradientColorTemp.FGreen) -
          Pixel^.rgbGreen)) shr 8;
        Pixel^.rgbBlue := Pixel^.rgbBlue +
          (GradientColorTemp.FAlphaBlend *
          ((Pixel^.rgbBlue xor GradientColorTemp.FBlue) -
          Pixel^.rgbBlue)) shr 8;
      end
    end
  end
...
begin
  ...
  begin
    ...
    begin
      Inc(Pixel^.rgbRed, (InputColor.FAlphaBlend * (InputColor.FRed -
        Pixel^.rgbRed)) shr 8);
      Inc(Pixel^.rgbGreen,
        (InputColor.FAlphaBlend * (InputColor.FGreen - Pixel^.rgbGreen)) shr 8);
      Inc(Pixel^.rgbBlue,
        (InputColor.FAlphaBlend * (InputColor.FBlue - Pixel^.rgbBlue)) shr 8);
    end
  end
end;
...
procedure TacSLCanvas32.GradientFill(Point1, Point2: TPoint; Reverse: boolean;
  Style: TacSLGradientStyle);
begin
...
begin
  Result := GetColor24(FRGBAGradient.Red, FRGBAGradient.Green,
    FRGBAGradient.Blue);
end;
