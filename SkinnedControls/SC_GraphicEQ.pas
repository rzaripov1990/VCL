...
type
  ...
  published
    ...
    property ClrMiddle: TColor read fMiddle write SetMiddleLineColor default clYellow;
...
begin
  ...
  begin
    ...
    begin
      ...
      fBuffer.Canvas.LineTo(Width, (Height - 1) - Trunc(CalcBandPosY(fPreamp)));
...
// ******************************************************************************
procedure TZMSMediaGraphicEQ.Resize;
begin
  inherited;
end;
// ******************************************************************************
